// ==========================================================================
// FOODIES POINT SERVICE WORKER (v41 - AUTO-UPDATING & CACHE PURGING)
// ==========================================================================
const CACHE_NAME = 'fp-cache-v41';

const ASSETS_TO_CACHE = [
  '/foodies-point-beta/',
  '/foodies-point-beta/index.html?v=41',
  '/foodies-point-beta/app.js?v=41',
  '/foodies-point-beta/manifest.json?v=41',
  '/foodies-point-beta/icon.png'
];

// 1. INSTALL EVENT: Force the new Service Worker to activate immediately
self.addEventListener('install', (event) => {
  console.log('[SW v41] Installing new service worker...');
  event.waitUntil(
...
self.addEventListener('activate', (event) => {
  console.log('[SW v41] Activating & wiping old caches...');
  event.waitUntil(
      ...
      return Promise.all(
        cacheNames.map((cacheName) => {
          ...
          if (cacheName !== CACHE_NAME) {
            console.log('[SW v41] Purging stale cache:', cacheName);
